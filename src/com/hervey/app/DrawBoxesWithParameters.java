...
public class DrawBoxesWithParameters {
	//When lines are too long to display on Eclipse, using Alt-Shift-Y will toggle Word Wrap
	...
	public static void drawBoxesThisHeightThisWidth(int height, int width) {
		//top and bottom or the same, so they could drawn using another method and called twice in this method
		//draw top
		System.out.print("+");
	...
	public static void drawNumberWidthHeight(int quantity, int width, int height) {
		System.out.println("Now we will draw this many boxes: " + quantity + " ,with this width and height:  " + width + " , " +height);
