...
public class DrawBoxes3 {
	...
	public static void main(String[] args) {
		...
		DrawBoxesWithParameters.drawSpecifiedNumberOfBoxes(3); //I created this method before it existed, then let Eclipse create the method header automatically
		
		//Let's draw 2 boxes with width 8, and height of 4
		//Note:  height and width must be at least two, testing for this would make the methods more complicated
